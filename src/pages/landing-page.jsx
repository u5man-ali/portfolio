...
export default function LandingPage() {
  const slides = [
    {
      ...
      content: (
        <div className="h-64 w-full flex items-center justify-center bg-aqua-100 text-xl font-bold rounded-md">
          This is Slide 1
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="h-64 w-full flex items-center justify-center bg-green-100 text-xl font-bold rounded-md">
          This is Slide 2
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="h-64 w-full flex items-center justify-center bg-red-100 text-xl font-bold rounded-md">
          This is Slide 3
        </div>
      ),
    },
  ...
  return (
    <div className="flex justify-center items-center gap-4 mb-4 flex-wrap">
        ...
        <Carousel slides={slides} duration={5000} />
