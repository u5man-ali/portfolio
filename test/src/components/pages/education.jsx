...
export default function buttonDemo() {
  return (
    <div className="flex justify-center items-center gap-4 mb-4 flex-wrap">
      <div className="flex-1 gap-4 flex-wrap">
        {/*Show both icons */}
        <p className="rtl:text-right rtl:flex-row-reverse text-3xl leading-normal font-body font-regular mb-6">قرآن و سنت میں "اسلام" کو "دین" کے طور پر متعارف کرایا گیا ہے:-<br></br></p>
        <p className = "font-disp rtl:text-center text-2xl font-medium">اِنَّ الدِّيۡنَ عِنۡدَ اللّٰهِ الۡاِسۡلَامُ<br></br>

        'اللہ کے نزدیک حقیقی دین صرف اسلام ہے!'</p>
        <p className="rtl:text-right rtl:flex-row-reverse text-3xl leading-normal font-body font-regular mb-6">قرآن و سنت میں "دین" کو "اسلام" کے طور پر متعارف کرایا گیا ہے۔
