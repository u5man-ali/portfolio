...
const styles = {
  neutral: {
    ...
    link: "bg-transparent text-black-600 hover:underline active:text-black-700"
  },
  primary: {
    ...
    link: "bg-transparent text-aqua-600 hover:underline active:text-aqua-700"
  },
  success: {
    ...
    link: "bg-transparent text-green-700 hover:underline active:text-gree-800"
  },
  error: {
